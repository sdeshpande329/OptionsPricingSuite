...
class MertonJumpDiffusionModel:
    ...
    def compute_greeks(self, contract: EuropeanOption, spot: float, scheme: str = "imex_euler",
                       S_min: float = None, S_max: float = None, N_S: int = 100, N_t: int = 100) -> Dict[str, float]:
        """
        Compute Delta, Gamma, Vega, and Theta via finite differences on the PIDE solution grid.
        """
        ...
        solver_vega = IMEXSolver(scheme=scheme)
